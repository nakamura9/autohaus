...
const AboutPage = () => (
    <div className={styles.container}>
        <h1 className={styles.title}>About ZimForward</h1>
        <div className={styles.content}>
            <p>Welcome to ZimForward, your trusted online marketplace for buying and selling quality vehicles. We connect buyers with verified dealers and private sellers, making the car buying experience seamless, transparent, and reliable.</p>
